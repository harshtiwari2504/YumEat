    ...
    <div className="max-w[1520] mx-auto flex justify-between items-center p-4">
        <div className="flex items-center">
            ...
            <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]">
                ...
                <p className="p-2 texl-bold">Delivery</p>
            </div>
        </div>
        ...
        <button className="bg-orange-700 text-white hidden md:flex items-center py-2 px-4 rounded-full"><BsFillCartFill size={20}/> Cart</button>
        {
            sideNav ? (
        ...
        : "fixed top-0 left-[-100%] w-[300px] h-screen bg-whhite z-10 duration-300"}>
